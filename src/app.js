...
(function () {
    ...
    function setupRemoveButton() {
        console.info("SetupRemoveButton");


        var template = document.createElement('template');


        var newButton = `<button class="nikola">
        ...
        template.innerHTML = newButton.trim();

        template.onclick = function () {
            alert('here be dragons'); return false;
        };

        var menus = document.getElementById("contents").querySelectorAll("#menu");
    ...
    setupEventListeners(){
        document.addEventListener('click', (el, e) => {
            console.info("LINDSEEEEY LOOOHAAAAAN " + Date.now);
        });
    }
